 ...
 * @file
 *
 * Install of build options for a Mullins FT3b platform solution
 *
 * This file generates the defaults tables for the "Mullins FT3b" platform solution
 ...
 * @e project:      AGESA
 * @e sub-project:  Core
 * @e \$Revision: 285942 $   @e \$Date: 2014-02-26 09:22:53 -0600 (Wed, 26 Feb 2014) $
 */
/*****************************************************************************
 *
 ...
 ****************************************************************************/
                  // This is the delivery package title, "MullinsPI        "
                  // This string MUST be exactly 16 characters long
#define AGESA_PACKAGE_STRING  {'M', 'u', 'l', 'l', 'i', 'n', 's', 'P', 'I', ' ', ' ', ' ', ' ', ' ', ' ', ' '}
...
// The Mullins FT3b solution is defined to be family 0x16 models 0x30 - 0x3F in the FT3b sockets.
#define INSTALL_FT3_SOCKET_SUPPORT           TRUE
#define INSTALL_FAMILY_16_MODEL_3x_SUPPORT   TRUE
