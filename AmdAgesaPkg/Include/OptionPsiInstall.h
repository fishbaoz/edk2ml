...
#define F16_ML_PSI_SUPPORT
    ...
    // Family 16h
          ...
          #undef OPTION_CPU_PSI_FEAT
          #define OPTION_CPU_PSI_FEAT &CpuFeaturePsi,
          extern CONST PSI_FAMILY_SERVICES ROMDATA F16MlPsiSupport;
          #undef F16_ML_PSI_SUPPORT
          #define F16_ML_PSI_SUPPORT {AMD_FAMILY_16_ML, &F16MlPsiSupport},
        #endif
      #endif
    #endif
