...
#define  FAM16_ML_DMI_TABLE
  ...
  #error  BLDOPT: Option not defined: "OPTION_DMI"
    ...
    // Family 16
        ...
        #if OPTION_FAMILY16H_ML
          extern PROC_FAMILY_TABLE ProcFamily16MlDmiTable;
          #undef FAM16_ML_DMI_TABLE
          #define FAM16_ML_DMI_TABLE &ProcFamily16MlDmiTable,
        #endif
      #endif
    #endif
  #endif
