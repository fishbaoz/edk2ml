...
#define F16_ML_IO_CSTATE_SUPPORT
          ...
          #undef OPTION_IO_CSTATE_FEAT
          #define OPTION_IO_CSTATE_FEAT &CpuFeatureIoCstate,
          extern CONST IO_CSTATE_FAMILY_SERVICES ROMDATA F16MlIoCstateSupport;
          #undef F16_ML_IO_CSTATE_SUPPORT
          #define F16_ML_IO_CSTATE_SUPPORT {AMD_FAMILY_16_ML, &F16MlIoCstateSupport},
        #endif
      #endif
    #endif
