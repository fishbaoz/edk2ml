...
/// The Build time options configuration for ML-specific options
typedef struct {
  ...
  BOOLEAN               CfgSamuPatchEnabled;                ///< Samu fused patch
  ...
  BOOLEAN               CfgBatteryBoostEn;                  ///< Enable Battery Based Boost
  BOOLEAN               CfgSpgClockGatingEnable;            ///< SPG Clock Gating
  BOOLEAN               CfgPspDpmEn;                        ///< Default for PSP DPM
  UINT32                CfgSMUServiceEnablementBitMap;      ///< Bit map for SMU service enablement (1 means the service is enabled)
  BOOLEAN               CfgUseSMUServices;                  ///< Recovery mode override for SMU services
} GNB_BUILD_OPTIONS_ML;
