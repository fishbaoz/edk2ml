...
#define F16_ML_CPU_CFOH_SUPPORT
        ...
        #define OPTION_CPU_CACHE_FLUSH_ON_HALT_FEAT &CpuFeatureCacheFlushOnHalt,
          ...
          extern CONST CPU_CFOH_FAMILY_SERVICES ROMDATA F16MlCacheFlushOnHalt;
          #undef F16_ML_CPU_CFOH_SUPPORT
          #define F16_ML_CPU_CFOH_SUPPORT {AMD_FAMILY_16_ML, &F16MlCacheFlushOnHalt},
        #endif
      #endif
    #endif
  #endif
