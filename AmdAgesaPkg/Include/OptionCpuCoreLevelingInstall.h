...
#define F16_ML_CPU_CORELEVELING_SUPPORT
    ...
    // Family 16h
      ...
      #define OPTION_CPU_CORE_LEVELING_FEAT &CpuFeatureCoreLeveling,
        ...
        extern CONST CPU_CORE_LEVELING_FAMILY_SERVICES ROMDATA F16MlCoreLeveling;
        #undef F16_ML_CPU_CORELEVELING_SUPPORT
        #define F16_ML_CPU_CORELEVELING_SUPPORT {AMD_FAMILY_16_ML, &F16MlCoreLeveling},
      #endif
    #endif
...
{
  F16_ML_CPU_CORELEVELING_SUPPORT
  {0, NULL}
};
