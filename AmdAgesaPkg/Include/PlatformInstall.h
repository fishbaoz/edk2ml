...
#define OPTION_FAMILY16H_MODEL_3x    FALSE
...
// F16_3x is supported in FT3b
#ifdef INSTALL_FAMILY_16_MODEL_3x_SUPPORT
  #if  INSTALL_FAMILY_16_MODEL_3x_SUPPORT == TRUE
    #undef OPTION_FAMILY16H
    #define OPTION_FAMILY16H     TRUE
    #undef OPTION_FAMILY16H_MODEL_3x
    #define OPTION_FAMILY16H_MODEL_3x     TRUE
  #endif
#endif

/*  Turn off families not required by socket designations */
#if (OPTION_FAMILY16H_MODEL_3x == TRUE)
...
#if (OPTION_FAMILY16H_MODEL_3x == FALSE)
  #undef OPTION_FAMILY16H
...
#define OPTION_FAMILY16H_ML          FALSE

/*  Default all memory controllers to off  */
#define OPTION_MEMCTLR_ML            FALSE
...
/*  Enable all private controls based on socket/family enables  */
    ...
    #undef OPTION_FAMILY16H_ML
    #define OPTION_FAMILY16H_ML  TRUE
    #undef OPTION_MEMCTLR_ML
    #define OPTION_MEMCTLR_ML    TRUE
    ...
    #undef OPTION_DLLPDBYPASS
    #define OPTION_DLLPDBYPASS  TRUE
...
#else
  #define CFG_BATTERY_BOOST_TUNE         100
#endif

#ifdef BLDCFG_NUM_GFX_CORES_ENABLED
  #define CFG_NUM_GFX_CORES_ENABLED         BLDCFG_NUM_GFX_CORES_ENABLED
#else
  #define CFG_NUM_GFX_CORES_ENABLED         0xFFFFFFFFul
#endif
...
#ifdef BLDCFG_TSP_AC_DOCKED
  #define CFG_TSP_AC_DOCKED         BLDCFG_TSP_AC_DOCKED
#else
  #define CFG_TSP_AC_DOCKED         0
#endif

#ifdef BLDCFG_TSP_DC_DOCKED
  #define CFG_TSP_DC_DOCKED         BLDCFG_TSP_DC_DOCKED
#else
  #define CFG_TSP_DC_DOCKED         0
#endif

#ifdef BLDCFG_TSP_AC_UNDOCKED
  #define CFG_TSP_AC_UNDOCKED         BLDCFG_TSP_AC_UNDOCKED
#else
  #define CFG_TSP_AC_UNDOCKED         0
#endif

#ifdef BLDCFG_TSP_DC_UNDOCKED
  #define CFG_TSP_DC_UNDOCKED         BLDCFG_TSP_DC_UNDOCKED
#else
  #define CFG_TSP_DC_UNDOCKED         0
#endif
...
BUILD_OPT_CFG UserOptions = {
  ...
  CFG_NUM_GFX_CORES_ENABLED,            // CfgNumGfxCoresEnabled
  ...
  CFG_TSP_AC_DOCKED,                    // CfgTspAcDocked
  CFG_TSP_DC_DOCKED,                    // CfgTspDcDocked
  CFG_TSP_AC_UNDOCKED,                  // CfgTspAcUnDocked
  CFG_TSP_DC_UNDOCKED,                  // CfgTspDcUnDocked
...
CONST DISPATCH_TABLE ROMDATA ApDispatchTable[] =
{
  ...
  { 0, NULL }
      ...
      CONST CHAR8 *BldOptDebugOutput[] = {
          ...
          MAKE_DBG_STR (\nCfgNumGfxCoresEnabled         , CFG_NUM_GFX_CORES_ENABLED),
          ...
          MAKE_DBG_STR (\nCfgTspAcDocked                , CFG_TSP_AC_DOCKED),
          MAKE_DBG_STR (\nCfgTspDcDocked                , CFG_TSP_DC_DOCKED),
          MAKE_DBG_STR (\nCfgTspAcUnDocked              , CFG_TSP_AC_UNDOCKED),
          MAKE_DBG_STR (\nCfgTspDcUnDocked              , CFG_TSP_DC_UNDOCKED),
