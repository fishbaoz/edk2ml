...
!ifndef PLATFORM_NAME
  PLATFORM_NAME                         = FchAvalonModulePkg
  PLATFORM_GUID                         = DC4E0EA1-4EF2-5310-713E-79AF2AB40C5D
  PLATFORM_VERSION                      = 0.1
  DSC_SPECIFICATION                     = 0x00010006
  OUTPUT_DIRECTORY                      = Build/FchAvalonPkg
...
!endif #!ifndef PLATFORM_NAME
  ...
  DEFINE AMD_FCH_LIB_PATH               = $(AMD_DRIVER_PATH)/Fch/FchAvalonModulePkg/Library
  DEFINE AMD_FCH_DRIVER_PATH            = $(AMD_DRIVER_PATH)/Fch/FchAvalonModulePkg/
