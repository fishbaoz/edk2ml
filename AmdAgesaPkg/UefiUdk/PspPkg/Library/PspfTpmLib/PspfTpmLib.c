  ...
  )
{
  ...
  CopyMem ((VOID *) (UINTN) iTpmControlArea->CommandAddress, CommandBuffer, CommandSize);
  ...
  SetMem ((VOID *) (UINTN) iTpmControlArea->ResponseAddress, iTpmControlArea->ResponseSize, 0x0);
  ...
  )
{
  ...
  if (iTpmControlArea->ResponseSize) {
    CopyMem ( ResponseBuffer, (VOID *) (UINTN)iTpmControlArea->ResponseAddress, *ResponseSize);
  }
  iTpmControlArea->ResponseSize = iTPM_RESPONSE_BUFFER_SIZE;
