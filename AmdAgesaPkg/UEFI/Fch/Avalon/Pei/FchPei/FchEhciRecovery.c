...
#define FILECODE UEFI_FCH_AVALON_PEI_FCHPEI_FCHEHCIRECOVERY_FILECODE
  ...
  )
{
  ...
  EnableEhciController (AVALON_EHCI1_BUS_DEV_FUN << 16, EhciTemporaryBarAddress, &StdHeader);
  EnableEhciController (AVALON_EHCI2_BUS_DEV_FUN << 16, EhciTemporaryBarAddress + 0x400, &StdHeader);
  EnableEhciController (AVALON_EHCI3_BUS_DEV_FUN << 16, EhciTemporaryBarAddress + 0x800, &StdHeader);
  return EFI_SUCCESS;
}
