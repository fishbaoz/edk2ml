...
#include "Smbus.h"
#define FILECODE UEFI_FCH_AVALON_PEI_SMBUS_SMBUS_FILECODE
  ...
  )
{
  ...
  Value16 = ReadPmio16 (PeiServices, CpuIo, FCH_ML_PMIOA_REG04);
  WritePmio16 (PeiServices, CpuIo, FCH_ML_PMIOA_REG04, Value16 | BIT1);
  Value16 = ReadPmio16 (PeiServices, CpuIo, FCH_ML_PMIOA_REG00);
  PEI_ASSERT (PeiServices, Value16);
  WritePmio16 (PeiServices, CpuIo, FCH_ML_PMIOA_REG00, Value16 | BIT4);
  Value16 &= 0xFF00;
