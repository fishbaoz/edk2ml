...
[=============================================================================]
#
# Instructions for building the FCH ACPI table storage file
#
[=============================================================================]
[Build.Ia32.FCH_ACPI_TABLES,Build.x64.FCH_ACPI_TABLES]
#
...
[=============================================================================]
[Package.FCH_ACPI_TABLES.Default]
PACKAGE.INF
\[.]
BASE_NAME                   = $(BASE_NAME)
FFS_FILEGUID                = $(FILE_GUID)
