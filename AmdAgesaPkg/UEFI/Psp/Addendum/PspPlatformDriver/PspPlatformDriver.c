 ...
 * @file
 *
 * PSP Platform Protocol reference Codes
 *
 *
...
#define PSP_NOTIFY_SMM        0xDD
#define RESUME_BSP_STACK_SIZE (1024 * 64)
...
EFI_DRIVER_ENTRY_POINT (PspPlatformEntryPoint)
EFI_STATUS
  ...
  )
{
  ...
  //it based on Resume SEC phase design. For now hardcode some number
  RsmInfoLocation = (*(UINT64 *) (UINT64) (0xFFFFFFF3)) & 0xffff;
  RsmInfoLocation += 0xFFF5;
  RsmInfoLocation = (RsmInfoLocation & 0xFFFF) | 0xFFFF0000;
