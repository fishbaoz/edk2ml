...
#define FILECODE UEFI_PSP_DRIVERS_PSPP2CMBOX_PSPP2CMBOXCMD_FILECODE
  ...
  )
{
  ...
  Status = PspGetVolumeAttributes ( (EFI_FVB_ATTRIBUTES *) &(Req->Attribute));
  ...
  )
{
  ...
  Status = PspSetVolumeAttributes ( (EFI_FVB_ATTRIBUTES *) &(Req->Attribute));
