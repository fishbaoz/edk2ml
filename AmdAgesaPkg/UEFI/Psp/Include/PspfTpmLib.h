...
typedef struct {
  ...
  VOLATILE UINT64                InterfaceIdentifier; ///< 00 Interface Identifier

  // TPM2 Control Area Extension
  VOLATILE UINT32                 Clear;            ///< 08 Clear
  VOLATILE UINT32                 RemainingBytes;   ///< 0C RemainingBytes
  VOLATILE UINT32                 StatusReserved;   ///< 10 StatusReserved
  VOLATILE UINT32                 StatusError;      ///< 14 StatusError
  VOLATILE UINT32                 StatusCancel;     ///< 18 StatusCancel
  VOLATILE UINT32                 StatusStart;      ///< 1C StatusStart
  UINT64                          InterruptControl; ///< 20 InterruptControl
  UINT32                          CommandSize;      ///< 28 CommandSize
  EFI_PHYSICAL_ADDRESS            CommandAddress;   ///< 2C CommandAddress
  UINT32                          ResponseSize;     ///< 34 ResponseSize
  EFI_PHYSICAL_ADDRESS            ResponseAddress;  ///< 38 ResponseAddress
// Memory Absent command/response buffer
  VOLATILE UINT32                 CmdRespHWBuffer;  ///< 40 Cmd/Rsp HW Buffer
