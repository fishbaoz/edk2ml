 ...
 * @file
 *
 * PSP SMM load related functions
 *
 *
...
#define FILECODE UEFI_PSP_LIBRARY_SMMLOAD_SMMLOAD_FILECODE
...
RegDriverToSmm (
  ...
  IN      EFI_SMM_BASE_PROTOCOL   *SmmBase
  )
{
  EFI_STATUS Status;
  ...
  if ((ImageHandle == NULL) || (SystemTable == NULL) || (SmmBase == NULL)) {
