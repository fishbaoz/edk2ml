 ...
 * @file
 *
 * AMD APEI DXE Driver for RAS
 *
 * Contains structures for APEI (WHEA) related DXE driver definitions and support structures.
 *
 ...
 *
 * Description: AmdRasApeiDxeDriver.h - Contains structures for APEI (WHEA)
 *                                      related DXE driver definitions and support
 *                                      structures.
 *
 ******************************************************************************
 *
 ...
 ******************************************************************************
 */
#ifndef _AMD_RAS_APEI_DXE_DRIVER_H_
#define _AMD_RAS_APEI_DXE_DRIVER_H_
...
#endif
#endif // _AMD_RAS_APEI_DXE_DRIVER_H_
