...
// For platform which support Connected Standby, please please uncomment below code (1/4)
...
// For platform which support Connected Standby, please uncomment below code (2/4)
...
// For platform which support Connected Standby, please please uncomment below code (3/4)
...
AgesaPublishCsRestorationData (
  IN       UINTN             Reserved,
  IN OUT   CS_CALLOUT_STRUCT *CsRestoreTable
  )
{
// N O T I C E !!!
// For platform which support Connected Standby, please please uncomment below code (4/4)

//  UINT8                          Cmd;
//  UINTN                          Size;
//  EFI_STATUS                     Status;
//  EFI_HANDLE                     RegistrationHandle;
//  CS_RESUME_COMMUNICATE_PROTOCOL CsResumeCommunicate;


  //Install Comm protocol
//  CsResumeCommunicate.Revision = CS_RESUME_COMMUNICATE_REV;
//  CsResumeCommunicate.BufferLength = CsRestoreTable->CsRestoreTableSize;
//  CsResumeCommunicate.BufferPtr = CsRestoreTable->CsRestoreTable;
//  RegistrationHandle = NULL;
//  gBS->InstallProtocolInterface (
//          &RegistrationHandle,
//          &gCsResumeCommunicateProtocolGuid,
