 ...
 * @file
 *
 * AMD User options selection for a Mullins FT3b platform solution system
 *
...
//#define BLDOPT_REMOVE_CONNECTED_STANDBY           TRUE
//#define BLDOPT_REMOVE_S3_MEM_SUPPORT              TRUE

//This element selects whether P-States should be forced to be dependent, independent or per processor default,
// as reported by the ACPI _PSD object.
//#define BLDCFG_ACPI_PSTATES_PSD_POLICY        PsdPolicyProcessorDefault   // PsdPolicyProcessorDefault or PsdPolicyDependent or PsdPolicyIndependent
...
#define BLDCFG_DDR_PHY_DLL_BYPASS_MODE            TRUE
...
CONST AP_MTRR_SETTINGS ROMDATA MullinsApMtrrSettingsList[] =
{
...
#define BLDCFG_AP_MTRR_SETTINGS_LIST &MullinsApMtrrSettingsList

#include  "MullinsFt3bInstall.h"
...
// Customer table
UINT8 AGESA_MEM_TABLE_ML[][sizeof (MEM_TABLE_ALIAS)] =
{
...
UINT8 SizeOfTableML = sizeof (AGESA_MEM_TABLE_ML) / sizeof (AGESA_MEM_TABLE_ML[0]);
