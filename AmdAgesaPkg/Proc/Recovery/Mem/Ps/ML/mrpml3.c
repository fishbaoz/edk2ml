...
#define FILECODE PROC_RECOVERY_MEM_PS_ML_MRPML3_FILECODE
/*----------------------------------------------------------------------------
...
//
CONST PSCFG_MR0WR_ENTRY RecMLMR0WR[] = {
  {0x10, 0},
  {0x05, 1},
  {0x06, 2},
  {0x07, 3},
...
//
CONST PSCFG_MR0CL_ENTRY RecMLMR0CL[] = {
  {0x05, 1, 0},
  {0x06, 2, 0},
  {0x07, 3, 0},
  {0x08, 4, 0},
...
//
STATIC CONST PSCFG_2D_ODTPAT_ENTRY RecMLOdtPat[] = {
...
CONST PSC_TBL_ENTRY RecMLOdtPatTblEnt = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_16_ML, AMD_F16_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (RecMLOdtPat) / sizeof (PSCFG_2D_ODTPAT_ENTRY),
   (VOID *)&RecMLOdtPat
};
