 ...
 * mrnmctml.c
 *
 * Northbridge ML MCT supporting functions Recovery
 *
...
#define FILECODE PROC_RECOVERY_MEM_NB_ML_MRNMCTML_FILECODE
/*----------------------------------------------------------------------------
...
/**
 *
 *      This function is the Recovery memory configuration function for ML DDR3
 *
