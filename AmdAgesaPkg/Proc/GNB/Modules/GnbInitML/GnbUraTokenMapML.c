...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITML_GNBURATOKENMAPML_FILECODE
...
REG_FIELD_TABLE_STRUCT  UraTableML = {
  ...
  {D0F0xBC_xC0000004_BootSeqDone_OFFSET, D0F0xBC_xC0000004_BootSeqDone_WIDTH, FIELD_OFFSET(RxSmuRcuUcEvents ,BfxSmuBootSeqDone)}, ///< TBfxSmuBootSeqDone
  {D0F0xBC_xC0000024_ADDRESS, D0F0xBC_xC0000024_TYPE, 0}, ///< TRxSmuFwFlags
  {D0F0xBC_xC0000024_InterruptsEnabled_OFFSET, D0F0xBC_xC0000024_InterruptsEnabled_WIDTH, FIELD_OFFSET(RxSmuFwFlags ,BfxSmuInterruptsEnabled)}, ///< TBfxSmuInterruptsEnabled
...
{
  *UraTableAddress = (UINT32)((UINTN)(&UraTableML));
  return;
}
