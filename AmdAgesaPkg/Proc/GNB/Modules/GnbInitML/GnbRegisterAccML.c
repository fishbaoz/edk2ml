...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITML_GNBREGISTERACCML_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  PstateChanged = GnbDctMpConfigML (
                    DctCfgSel,
                    MemPsSel,
                    Flags,
                    StdHeader
  ...
  GnbLibPciWrite (
    MAKE_SBDFO (0, 0, 0x18, 2, D18F2x98_dct0_ADDRESS),
    Width,
    &D18F2x98.Value,
    StdHeader
  );
  ...
  GnbLibPciRead (
    MAKE_SBDFO (0, 0, 0x18, 2, D18F2x9C_dct0_ADDRESS),
    Width,
    Value,
    StdHeader
  );
  ...
  )
{
  ...
  GNB_DEBUG_CODE (
    GnbRegisterWriteMLDump (RegisterSpaceType, Address, Value);
  );
