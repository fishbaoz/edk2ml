...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITML_GNBURAML_FILECODE
  ...
  )
{
  ...
  case TYPE_GNB_PROTOCOL_ACCESS:
    ...
    GnbRegisterReadML (Device->GnbHandle, (UINT8)TargetAddress, UraTokenInfo->RegAddress, &RegValue, UraTokenInfo->Flags, Device->StdHeader);
