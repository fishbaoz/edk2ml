...
*
*/
#ifndef _GNBFUSETABLEML_H_
#define _GNBFUSETABLEML_H_
...
typedef struct {
  ...
  FUSE_REGISTER_ENTRY_ML   *FuseRegisterTable;       ///< Pointer to field table
} FUSE_TABLE_ENTRY_ML;

/// Fuse translation table
typedef struct {
  UINT8                    FuseTableLength;          ///< Length of translation table
  FUSE_TABLE_ENTRY_ML      *FuseTable;               ///< Pointer to register table
} FUSE_TABLE_ML;
