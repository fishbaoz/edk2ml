...
#define FILECODE PROC_MEM_NB_ML_MNIDENDIMMML_FILECODE
  ...
  )
{
  ...
  if (!MemNIsIdSupportedML (&(MemPtr->DiesPerSystem[BSP_DIE].LogicalCpuid))) {
    return AGESA_ERROR;
  }
      ...
      for (cs = 0; cs < MAX_CS_PER_CHANNEL; ++ cs) {
        ...
        if (CSEn && ((InputAddr & ~CSMask) == (CSBase & ~CSMask))) {
          ...
          *ChipSelect = cs;
          ...
          NormalizedToBankAddrMapML (ChannelAddr, CSMask, DimmAddrMap, RankDef, BankSwap, DctSelBankSwap, BankSwizzleMode, Bank, Row, Col);
...
{
  UINT64 Addr;
  ChannelAddr = BankSwapAddrML (BankSwap, ChannelAddr, DctSelBankSwap);

  // BankSwizzleMode is calculated on the normalized addr
  // Select Row/Col based on the CS interleave adjustment tables
  switch (DimmAddrMap) {
  case 0x1:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 13, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 28, !BankSwap ? 16 : (DctSelBankSwap ? 11 : 12));
    *Row = (UINT32) (((Addr >> 18) & 0x3FF) | (((Addr >> 16) & 0x3) << 10));
    *Col = (UINT16) ((Addr >> 3) & 0x3FF);
    break;
  case 0x2:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 13, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 29, !BankSwap ? 16 : (DctSelBankSwap ? 11 : 12));
    *Row = (UINT32) (((Addr >> 18) & 0x7FF) | (((Addr >> 16) & 0x3) << 11));
    *Col = (UINT16) ((Addr >> 3) & 0x3FF);
    break;
  case 0x5:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 13, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 30, !BankSwap ? 16 : (DctSelBankSwap ? 11 : 12));
    *Row = (UINT32) (((Addr >> 18) & 0xFFF) | (((Addr >> 16) & 0x3) << 12));
    *Col = (UINT16) ((Addr >> 3) & 0x3FF);
    break;
  case 0x7:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 13, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 31, !BankSwap ? 16 : (DctSelBankSwap ? 11 : 12));
    *Row = (UINT32) (((Addr >> 18) & 0x1FFF) | (((Addr >> 16) & 0x3) << 13));
    *Col = (UINT16) ((Addr >> 3) & 0x3FF);
    break;
  case 0xA:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 13, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 32, !BankSwap ? 16 : (DctSelBankSwap ? 11 : 12));
    *Row = (UINT32) (((Addr >> 18) & 0x3FFF) | (((Addr >> 16) & 0x3) << 14));
    *Col = (UINT16) ((Addr >> 3) & 0x3FF);
    break;
  case 0xB:
    *Bank = (UINT8)AddrToBankSwizzleML (BankSwizzleMode, ChannelAddr, 14, 0);
    Addr = CSInterleavingBitSwapML (ChannelAddr, CSMask, 33, !BankSwap ? 17 : (DctSelBankSwap ? 11 : 12));
