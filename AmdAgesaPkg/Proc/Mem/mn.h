...
typedef enum {
  ...
  DllPDBypassFenceThresholdTxPadTraining, ///< DllPDBypass function to skip FenceThresholdTxPad training
  DllPDBypassWrDatTraining,        ///< DllPDBypass function to skip WrDat training
  DllPDBypassRepeatRxEnTrn,        ///< DllPDBypass function to repeat Rx En training for 667
