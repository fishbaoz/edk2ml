...
#include "Filecode.h"
#define FILECODE PROC_FCH_AVALON_AVALONHWM_AVALONHWMENVSERVICE_FILECODE

//Temperature At
#define AVALON_T0AT        5220
#define AVALON_T1AT        5225
#define AVALON_T2AT        5220
#define AVALON_T3AT        5212
#define AVALON_T4AT        5123

//Temperature Ct
#define AVALON_T0CT        27365
#define AVALON_T1CT        27435
#define AVALON_T2CT        27516
#define AVALON_T3CT        27580
#define AVALON_T4CT        27866

FCH_HWM_TEMP_PAR TempParDefault[] = {
  { AVALON_T1AT, AVALON_T0CT , 0 },
  { AVALON_T1AT, AVALON_T1CT , 0 },
  { AVALON_T2AT, AVALON_T2CT , BIT0 },         ///High Ratio
  { AVALON_T3AT, AVALON_T3CT , BIT1 },         ///High Current
  { AVALON_T4AT, AVALON_T4CT , 0 }
};
