 ...
 * @file
 *
 * AMD Family_16 Mullins after warm reset sequence for NB P-states
 *
...
#define FILECODE PROC_CPU_FAMILY_0X16_ML_F16MLNBAFTERRESET_FILECODE
...
/*---------------------------------------------------------------------------------------*/
/**
 * Family 16h Mullins core 0 entry point for performing the necessary steps after
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (CPU_TRACE, "  F16MlPmNbAfterReset\n");
  ...
  TaskPtr.FuncAddress.PfApTask = F16MlPmNbAfterResetOnCore;
...
/*---------------------------------------------------------------------------------------*/
/**
 * Support routine for F16MlPmNbAfterReset to perform MSR initialization on one
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (CPU_TRACE, "  F16MlPmNbAfterResetOnCore\n");
...
/*---------------------------------------------------------------------------------------*/
/**
 * Support routine for F16MlPmNbAfterResetOnCore to transition to the low NB P-state.
 *
...
/*---------------------------------------------------------------------------------------*/
/**
 * Support routine for F16MlPmNbAfterResetOnCore to transition to the high NB P-state.
 *
...
/*---------------------------------------------------------------------------------------*/
/**
 * Support routine for F16MlPmAfterResetCore to wait for NB FID and DID to
