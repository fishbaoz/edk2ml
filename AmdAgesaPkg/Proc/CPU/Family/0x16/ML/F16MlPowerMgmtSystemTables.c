 ...
 * @file
 *
 * AMD Family_16 Models 0x30 - 0x3F Mullins Power Management related initialization table
 *
...
#define FILECODE PROC_CPU_FAMILY_0X16_ML_F16MLPOWERMGMTSYSTEMTABLES_FILECODE
...
/*  Family 16h Mullins Only Table */
/* ---------------------- */
CONST SYS_PM_TBL_STEP ROMDATA CpuF16MlSysPmTableArray[] =
{
  /// @todo
  IDS_INITIAL_F16_ML_PM_STEP
  ...
  {
    0,                                                // ExeFlags
    F16MlNbPstateDis                                  // Function Pointer
  },
  ...
  //   Execute only after warm reset
  {
    ...
    F16MlPmCoreAfterReset                             // Function Pointer
  },
  ...
  {
    PM_EXEFLAGS_WARM_ONLY,                            // ExeFlags
    F16MlPmNbAfterReset                               // Function Pointer
  },
  ...
  {
    0,                                                // ExeFlags
    F16MlPmPwrCheck                                   // Function Pointer
  },

  IDS_F16_ML_PM_CUSTOM_STEP
};
...
{
  *NumberOfElements = (sizeof (CpuF16MlSysPmTableArray) / sizeof (SYS_PM_TBL_STEP));
  *SysPmTblPtr = CpuF16MlSysPmTableArray;
}
